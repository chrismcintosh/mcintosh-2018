...
if ( ! function_exists( 'mcintosh_setup' ) ) :
	...
	function mcintosh_setup() {
		 ...
		 * If you're building a theme based on mcintosh-18, use a find and replace
		 * to change 'mcintosh' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'mcintosh', get_template_directory() . '/languages' );
...
function mcintosh_scripts() {
	...
	wp_enqueue_script( 'mcintosh-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'mcintosh-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
